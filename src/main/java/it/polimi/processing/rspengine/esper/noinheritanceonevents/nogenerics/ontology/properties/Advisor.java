...
public class Advisor extends RDFProperty {
	...
	public Advisor() {
		super("http://swat.cse.lehigh.edu/onto/univ-bench.owl#advisor",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Person",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Professor",
				Person.class, Professor.class);
	}

	public Advisor(String property, String domainValue, String rangeValue,
