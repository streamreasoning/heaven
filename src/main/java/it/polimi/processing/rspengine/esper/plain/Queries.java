...
public class Queries {
	...
	public static final String rdfs3 = "on RDFS3Input(p!='"+RDFSUtils.TYPE_PROPERTY+"') "
			+ "insert into QueryOut select o as s, '"+RDFSUtils.TYPE_PROPERTY+"' as p, it.polimi.processing.rspengine.esper.plain.Ontology.range(p) as o, timestamp as timestamp , app_timestamp as app_timestamp, channel || 'RDSF3' as channel "
			+ "insert into RDFS9Input select o as s, '"+RDFSUtils.TYPE_PROPERTY+"' as p, it.polimi.processing.rspengine.esper.plain.Ontology.range(p) as o, timestamp as timestamp, app_timestamp as app_timestamp , channel || 'RDSF3' as channel "
			+ "insert into QueryOut select s as s, '"+RDFSUtils.TYPE_PROPERTY+"' as p, it.polimi.processing.rspengine.esper.plain.Ontology.domain(p) as o, timestamp as timestamp , app_timestamp as app_timestamp, channel || 'RDSF3' as channel "
			+ "insert into RDFS9Input select s as s, '"+RDFSUtils.TYPE_PROPERTY+"' as p, it.polimi.processing.rspengine.esper.plain.Ontology.domain(p) as o, timestamp as timestamp , app_timestamp as app_timestamp, channel || 'RDSF3' as channel "
			+ "output all";
