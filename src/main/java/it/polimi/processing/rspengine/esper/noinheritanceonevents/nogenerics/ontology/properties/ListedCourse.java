...
public class ListedCourse extends RDFProperty {
	...
	public ListedCourse() {
		super("http://swat.cse.lehigh.edu/onto/univ-bench.owl#listedCourse",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Schedule",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Course",
				Person.class, Course.class);
	}

	public ListedCourse(String property, String domainValue, String rangeValue,
