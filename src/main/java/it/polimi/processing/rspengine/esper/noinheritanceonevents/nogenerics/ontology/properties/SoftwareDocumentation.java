...
public class SoftwareDocumentation extends RDFProperty {
	...
	public SoftwareDocumentation() {
		super("http://swat.cse.lehigh.edu/onto/univ-bench.owl#softwareDocumentation", "http://swat.cse.lehigh.edu/onto/univ-bench.owl#Software",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Publication", Software.class, Publication.class);
	}

	public SoftwareDocumentation(String property, String domainValue, String rangeValue, Class<? extends RDFResource> domain,
