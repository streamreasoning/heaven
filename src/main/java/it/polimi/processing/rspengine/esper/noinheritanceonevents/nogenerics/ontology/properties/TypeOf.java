...
public class TypeOf extends RDFProperty {
	...
	public TypeOf() {
		super("http://www.w3.org/1999/02/22-rdf-syntax-ns#type", "http://www.w3.org/2000/01/rdf-schema#Resource",
				"http://www.w3.org/1999/02/22-rdf-schema#Class", RDFResource.class, RDFClass.class);
	}
}
