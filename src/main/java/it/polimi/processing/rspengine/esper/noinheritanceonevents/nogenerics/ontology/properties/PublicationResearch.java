...
public class PublicationResearch extends RDFProperty {
	...
	public PublicationResearch() {
		super("http://swat.cse.lehigh.edu/onto/univ-bench.owl#publicationResearch", "http://swat.cse.lehigh.edu/onto/univ-bench.owl#Publication",
				"http://swat.cse.lehigh.edu/onto/univ-bench.owl#Research", Publication.class, Research.class);
	}

	public PublicationResearch(String property, String domainValue, String rangeValue, Class<? extends RDFResource> domain,
