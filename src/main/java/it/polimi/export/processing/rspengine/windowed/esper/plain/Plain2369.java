package it.polimi.export.processing.rspengine.windowed.esper.plain;

import it.polimi.export.processing.rspengine.windowed.esper.plain.events.Out;
import it.polimi.export.processing.rspengine.windowed.esper.plain.events.TEvent;
import it.polimi.export.processing.rspengine.windowed.esper.plain.utils.Ontology;
...
public class Plain2369 extends RSPEsperEngine {
	...
	public Plain2369(String name, EventProcessor<CTEvent> collector, String runtimeOnto, String ontologyClass, UpdateListener listener) {
