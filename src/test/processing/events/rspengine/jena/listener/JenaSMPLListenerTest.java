...
import it.polimi.processing.rspengine.windowed.jena.timecontrol.snapshot.listener.JenaSMPLListener;
...
public class JenaSMPLListenerTest {
	...
	public void stmtEventTest() {
		...
		listener = new JenaSMPLListener(RDFSUtils.loadModel(FileUtils.UNIV_BENCH_RDFS_MODIFIED), null);
