...
public final class RDF2RDFStream extends TSStreamer {
	...
	protected FlowRateProfiler<Stimulus> profiler;

	public RDF2RDFStream(EventProcessor<Stimulus> processor, FlowRateProfiler<Stimulus> profiler, int eventLimit) {
		super(processor, ExecutionState.CLOSED, eventLimit);
		this.profiler = profiler;
	}

	public RDF2RDFStream(EventProcessor<Stimulus> processor, FlowRateProfiler<Stimulus> profiler) {
